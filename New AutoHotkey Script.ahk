...
Gui,5: Add, Text, x152 y0 w140 h20 +Center +BackgroundTrans +BackgroundTrans, Clients for Venture
Gui,5: Add, Text, x2 y0 w140 h20 +Center +BackgroundTrans, Venture
Gui,5: Add, Link, x2 y280 w140 h30 ,<a id="A">click to create a new venture</a>
Gui,5: Add, Text, x302 y0 w270 h20 +Center +BackgroundTrans, Client
